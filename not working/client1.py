...
sock.sendto((user_ID.encode('utf-8')), ('127.0.0.1', 32001))
...
# RESPONSE to server
sock.sendto(response.encode('utf-8'), ('127.0.0.1', 32001))
data, address = sock.recvfrom(1024)
if data == "AUTH_FAIL":
    print("AUTH_FAIL")
else:
...
client_b_online = False
while not client_b_online:
    try:
        data, address = sock.recvfrom(1024)
        client_b_online = True
        break
